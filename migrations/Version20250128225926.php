 ...
 */
final class Version20250128225926 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE asistencia (id INT AUTO_INCREMENT NOT NULL, asi_fechaentrada DATETIME NOT NULL, asi_fechasalida DATETIME DEFAULT NULL, asi_horaentrada TIME NOT NULL, asi_horasalida TIME DEFAULT NULL, asi_fotoentrada VARCHAR(255) NOT NULL, asi_fotosalida VARCHAR(255) DEFAULT NULL, asi_ubicacionentrada VARCHAR(255) NOT NULL, asi_ubicacionsalida VARCHAR(255) DEFAULT NULL, asi_estadoentrada VARCHAR(255) NOT NULL, asi_estadosalida VARCHAR(255) DEFAULT NULL, asi_notas VARCHAR(255) NOT NULL, asi_eliminado TINYINT(1) NOT NULL, colaborador_id INT NOT NULL, INDEX IDX_D8264A8DF1CB264E (colaborador_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE configuracion_asistencia (id INT AUTO_INCREMENT NOT NULL, cas_tiempo_falta_horas INT NOT NULL, cas_tolerancia_ingreso_minutos INT NOT NULL, cas_permitir_foto TINYINT(1) NOT NULL, cas_faltas_tardanzas TINYINT(1) NOT NULL, cas_permisos TINYINT(1) NOT NULL, cas_vacaciones TINYINT(1) NOT NULL, cas_marcacion TINYINT(1) NOT NULL, cas_modalidad VARCHAR(255) NOT NULL, cas_area TINYINT(1) NOT NULL, cas_puesto TINYINT(1) NOT NULL, cas_predhorario TINYINT(1) NOT NULL, cas_eliminado TINYINT(1) NOT NULL, cas_estado VARCHAR(255) NOT NULL, cas_horasextras TINYINT(1) NOT NULL, grupo_id INT NOT NULL, sede_id INT NOT NULL, puesto_id INT NOT NULL, INDEX IDX_FB7656889C833003 (grupo_id), INDEX IDX_FB765688E19F41BF (sede_id), INDEX IDX_FB7656885035E9DA (puesto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE horario_trabajo (id INT AUTO_INCREMENT NOT NULL, hot_diasemana VARCHAR(255) NOT NULL, hot_fecha DATE NOT NULL, hot_horaentrada TIME NOT NULL, hot_horasalida TIME NOT NULL, hot_tipojornada VARCHAR(255) NOT NULL, hot_eliminado TINYINT(1) NOT NULL, hot_descanso VARCHAR(255) NOT NULL, colaborador_id INT NOT NULL, INDEX IDX_DA85417F1CB264E (colaborador_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE motivo (id INT AUTO_INCREMENT NOT NULL, mtv_nombre VARCHAR(255) NOT NULL, mtv_eliminado TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
