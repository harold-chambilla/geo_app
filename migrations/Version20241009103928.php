 ...
 */
final class Version20241009103928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE configuracion_asistencia ADD COLUMN cas_faltas_tardanzas BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE configuracion_asistencia ADD COLUMN cas_permisos BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE configuracion_asistencia ADD COLUMN cas_vacaciones BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE configuracion_asistencia ADD COLUMN cas_marcacion BOOLEAN DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__configuracion_asistencia AS SELECT id, cas_modalidad, cas_eliminado, cas_area, cas_puesto, cas_estado, cas_predhorario, cas_empresa_id, cas_grupo_id, cas_sede_id FROM configuracion_asistencia');
