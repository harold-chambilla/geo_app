 ...
 */
final class Version20241017093826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE configuracion_asistencia ADD COLUMN cas_tiempo_falta_horas INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE configuracion_asistencia ADD COLUMN cas_tolerancia_ingreso_minutos INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE configuracion_asistencia ADD COLUMN cas_permitir_foto BOOLEAN DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__configuracion_asistencia AS SELECT id, cas_modalidad, cas_eliminado, cas_area, cas_puesto, cas_estado, cas_predhorario, cas_faltas_tardanzas, cas_permisos, cas_vacaciones, cas_marcacion, cas_empresa_id, cas_grupo_id, cas_sede_id FROM configuracion_asistencia');
        ...
        $this->addSql('INSERT INTO configuracion_asistencia (id, cas_modalidad, cas_eliminado, cas_area, cas_puesto, cas_estado, cas_predhorario, cas_faltas_tardanzas, cas_permisos, cas_vacaciones, cas_marcacion, cas_empresa_id, cas_grupo_id, cas_sede_id) SELECT id, cas_modalidad, cas_eliminado, cas_area, cas_puesto, cas_estado, cas_predhorario, cas_faltas_tardanzas, cas_permisos, cas_vacaciones, cas_marcacion, cas_empresa_id, cas_grupo_id, cas_sede_id FROM __temp__configuracion_asistencia');
