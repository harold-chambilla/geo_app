 ...
 */
final class Version20241102082001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE motivo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, mtv_nombre VARCHAR(255) NOT NULL, mtv_eliminado BOOLEAN NOT NULL)');
        $this->addSql('CREATE TABLE permiso (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, pms_estado VARCHAR(255) NOT NULL, pms_eliminado BOOLEAN NOT NULL, colaborador_id INTEGER NOT NULL, motivo_id INTEGER NOT NULL, CONSTRAINT FK_FD7AAB9EF1CB264E FOREIGN KEY (colaborador_id) REFERENCES colaborador (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_FD7AAB9EF9E584F8 FOREIGN KEY (motivo_id) REFERENCES motivo (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE sede (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sed_nombre VARCHAR(255) NOT NULL, sed_pais VARCHAR(255) NOT NULL, sed_direccion VARCHAR(255) NOT NULL, sed_ubicacion CLOB NOT NULL, sed_eliminado BOOLEAN NOT NULL)');
    }
