<template>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="text-container">
                    <div class="text-box">
                        <span class="text" >{{ entrada.estado }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <!-- Sección de información de puntualidad -->
                    <div class="text-container">
